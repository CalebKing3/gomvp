...
export function Header() {
  ...
  return (
    <header
      className={classNames('absolute top-0 z-60 text-white flex items-center pl-2 py-5 border-b h-[var(--header-height)] backdrop-blur-lg', {
    ...
    >
      <div className="flex items-center gap-2 z-logo text-bolt-elements-textPrimary cursor-pointer">
        ...
        <a href="/" className="text-2xl font-semibold text-accent flex items-center">
          ...
          <img src="/2.svg" alt="logo" className="w-[90px] inline-block z-50" />
        </a>
      </div>
